...
# Feature-Decoupled KD
# CFG.NEW = CN()
# CFG.NEW.LOSS = CN()
#
# CFG.NEW.LOSS.CE_WEIGHT = 1.0
# CFG.NEW.LOSS.FEAT_WEIGHT = 8.0
# CFG.NEW.LOSS.COSINE_DECAY_EPOCH = 0
#
# CFG.NEW.INPUT_SIZE=(224, 224)
# CFG.NEW.MASK_RATIO = 0.1
# CFG.NEW.LOW_HIGH_RATIO = 2.0
# CFG.NEW.EPS=0.00001
# CFG.NEW.PROJECTOR = 'bottleneck'
# CFG.NEW.INPUT_SIZE=(224, 224)
# CFG.NEW.HINT_LAYER = 4


CFG.FFD = CN()
CFG.FFD.LOSS = CN()

CFG.FFD.LOSS.CE_WEIGHT = 1.0
CFG.FFD.LOSS.FEAT_WEIGHT = 8.0
CFG.FFD.LOSS.COSINE_DECAY_EPOCH = 0

CFG.FFD.INPUT_SIZE=(224, 224)
CFG.FFD.MASK_RATIO = 0.1
CFG.FFD.LOW_HIGH_RATIO = 2.0
CFG.FFD.EPS=0.00001
CFG.FFD.PROJECTOR = 'bottleneck'
CFG.FFD.INPUT_SIZE=(224, 224)
CFG.FFD.HINT_LAYER = 4


CFG.LBL = CN()
CFG.LBL.LOSS = CN()
CFG.LBL.INPUT_SIZE=(224, 224)
CFG.LBL.LOSS.CE_WEIGHT = 1.0
